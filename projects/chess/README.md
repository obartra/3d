...
| - | - | - | - |
| ![A 3D render of a chess piece stand design inside a rectangular box. The render shows a stylized knight chess piece with a dog head, and several compartments for holding chess pieces.](./images/piece-box/box-set-design.png) | ![A purple box with the lid open, showing a translucent chess piece stand inside. The stand has multiple tiers, holding beige dog-themed chess pieces. The pieces are arranged neatly in their respective compartments.](./images/piece-box/open.jpeg) | ![A purple box with the lid partially open, revealing the translucent chess piece stand inside. The stand holds multiple beige chess pieces, arranged neatly in their respective compartments.](./images/piece-box//partially-open.jpeg) | ![A closed purple box with a black stylized knight chess piece featuring a dog head on the side. The box is placed on a light-colored wooden surface.](./images/piece-box/closed.jpeg) |
...
If you want to leave a comment or suggestion, you can do so [here](https://github.com/obartra/3d/issues/new).

![A workbench displaying a completed custom chess set. On the left is a purple painted pizza box with a black stylized knight chess piece featuring a dog head on the lid, containing the chessboard inside. On the right is a purple cube box with a similar black stylized knight chess piece on the side, containing the chess pieces and the stand. Various tools and supplies are visible in the background.](./images/complete.jpeg)
