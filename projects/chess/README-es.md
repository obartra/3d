...
| - | - | - | - |
| ![Renderizado 3D de un diseño de soporte para piezas de ajedrez dentro de una caja rectangular. El renderizado muestra una pieza de ajedrez de caballo estilizada con una cabeza de perro y varios compartimentos para contener piezas de ajedrez.](./images/piece-box/box-set-design.png) | TODO | ![Una caja morada con la tapa parcialmente abierta, revelando el soporte de piezas de ajedrez negro dentro. El soporte contiene múltiples piezas de ajedrez beige, dispuestas ordenadamente en sus respectivos compartimentos.](./images/piece-box//partially-open.jpeg) | ![Una caja cerrada de color morado con una pieza de ajedrez de caballo estilizada en negro con una cabeza de perro en el lateral. La caja está colocada sobre una superficie de madera clara.](./images/piece-box/closed.jpeg) |
